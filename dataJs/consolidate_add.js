...
function cdp_cal_final_total() {
  ...
  selected.forEach(function (valor, indice, array) {
    ...
    // Calculate CBM (Cubic Meter) - L x W x H / 1,000,000 (for cm)
  ...
  var total_envio =
    sumador_total - total_descuento + total_seguro + total_impuesto + total_impuesto_aduanero + reexpedicion_value;
