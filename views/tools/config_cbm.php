							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="show_package_dimensions">
										<i class="fas fa-eye"></i> Package Information Display
									</label>
									<div class="custom-control custom-switch">
									...
									<small class="form-text text-muted">Enable to show Length, Width, Height fields in shipment forms</small>
								</div>
							</div>
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="show_cbm_in_forms">
										<i class="fas fa-cube"></i> CBM Display in Forms
									</label>
									<div class="custom-control custom-switch">
									...
									<small class="form-text text-muted">Enable to show real-time CBM calculation in shipment forms</small>
								</div>
							</div>
						</div>
