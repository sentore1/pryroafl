		...
		<nav class="sidebar-nav">
			...
			<?php } else if ($userData->userlevel == 1) { ?>
				...
				<ul id="sidebarnav">
					...
					<li class="sidebar-item">
						<a class="sidebar-link waves-effect waves-dark" href="index.php" aria-expanded="false"><i class="ti ti-apps"></i>
							<span class="hide-menu"> <?php echo $lang['left-menu-sidebar-2'] ?> </span>
						</a>
					</li>
			...
			<?php } else if ($userData->userlevel == 3) { ?>
				<ul id="sidebarnav">
					...
					<li class="p-15 m-t-10">
						<a href="courier_add.php" class="btn btn-block create-btn text-white no-block d-flex align-items-center">
							<i class="ti-package" style="color:#fff !important"></i> <span class="hide-menu m-l-5"> <?php echo $lang['left-menu-sidebar-1'] ?> </span> </a>
					</li>
