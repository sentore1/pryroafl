...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 13px; font-family: helvetica">
    ...
    <table id="meta" style="width: 100%;  border-collapse: collapse;">
        <tr style="border: 1px solid black">
            ...
            <td style="border: 2px">
                <?php echo isset($met_payment->name_pay) ? $met_payment->name_pay : ''; ?>
            </td>
        </tr>
        <tr>
    ...
    <table id="items" style="width: 100%; border-collapse: collapse; margin-right:  5px">
        <tr style=" border: 1px solid black; padding: 2px;">
            ...
            <th style="color:white;  border: 1px solid black; padding: 2px;" width="31%"><b><?php echo $lang['left213'] ?></b></th>
            <th style="color:white;  border: 1px solid black; padding: 2px;" width="12%"><b><?php echo $lang['left215'] ?></b></th>
            <th style="color:white;  border: 1px solid black; padding: 2px;" width="12%"><b><?php echo $lang['left216'] ?></b></th>
            <th style="color:white;  border: 1px solid black; padding: 2px;" width="12%"><b><?php echo $lang['left217'] ?></b></th>
            <th style="color:white;  border: 1px solid black; padding: 2px;" width="12%"><b><?php echo $lang['left218'] ?></b></th>
            <th style="color:white;  border: 1px solid black; padding: 2px;" width="12%"><b>Weight vol</b></th>
            <th style="color:white; border: 1px solid black; padding: 2px;" width="12%"><b>Fixed charge</b></th>
            <th style="color:white;  border: 1px solid black; padding: 2px;" width="12%"><b>Declared value</b></th>
        </tr>
        ...
        ?>
            ...
            <tr class="item-row">
                ...
                <td style=" border: 1px solid black; padding: 3px;"><?php echo $row_item->order_item_fixed_value; ?></td>
